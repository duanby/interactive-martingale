...
# D:       size of grid D*D
# r:       size of non-null cluster (= radius^2)
# C:       coordinates of the center of the cluster
# mu_type: type of alternative mean (constant/fading)
...
# parent:    parent node if not generating from the root
# tree_type: type of tree structure (wide/other)
...
# tree_frame: a tree object generated by tree_structure
# n_1:        number of non-nulls
# mu_1:       non-null mean value
# mu_0:       null mean value
# decrease:   indicator of whether the probability of being non-null decreases from parent to child
# tree_type:  type of tree structure (wide/small)
